...
Current local status: `externalAgentConfig/import/readHistories` and
`plugin/installed` are exposed only through the explicit integration-inventory
opt-in. `permissionProfile/list`, `remoteControl/status/read`,
